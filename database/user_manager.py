...
class UserManager:
    ...
    def save_user(self, username, password, cookies=None):
        ...
        # MySQL kullanılabilir değilse sessizce başarısız döner
        if not self.mysql_config.is_mysql_available():
            print("⚠️ MySQL kullanılamıyor, kullanıcı kaydı atlanıyor")
            return False
